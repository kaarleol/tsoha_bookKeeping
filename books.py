...
def get_list():
    sql = text("SELECT B.book_id, B.title, B.author, B.publication_date, B.genre, U.username, B.added_by FROM book B, users U WHERE B.added_by=U.user_id ORDER BY B.book_id")
